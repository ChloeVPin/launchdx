...
complete -c launchdx -n "__fish_use_subcommand" -a diagnose -d "Inspect an application bundle and explain the evidence behind a launch blocker"
complete -c launchdx -n "__fish_use_subcommand" -a evidence -d "Show raw evidence for an application bundle"
